...
// index.html:1988
export const FASHION_CASUAL_TAGS = {'大学生カジュアル':/[csf]/,'私服通学風':/[cf]/,'社会人カジュアル':/o/,'ストリート系':/s/,'ジャケットスタイル':/k/,'きれいめカジュアル':/k/,'古着系':/f/};

// index.html:2123
export const ACC_NO_PIERCE = ['公務員','銀行員','自衛官','警察官','教員','消防士','裁判官','検察官'];

// index.html:2124
export const ACC_HI_PIERCE = ['美容師','アパレル店員','古着屋店主','バンドマン','ホスト','ミュージシャン','ダンサー','ネイリスト'];

// index.html:2125
export const ACC_WORK_OFF = ['看護師','医師','調理師','料理人','パン職人','寿司職人','工場勤務','整備士','歯科医師','薬剤師','介護士'];

// index.html:2731
export const ETHNIC_HAIR_WEIGHTS = {
...
// index.html:4187
export const FACE_EXTRA_DEFAULTS = {jawChin:'標準的な顎先', jawAngle:'ほどよく張ったエラ', ear:'標準的な耳', forehead:'標準的な広さの額', hairline:'直線的な生え際', cheek:'標準的な頬', dimple:'えくぼなし', mole:'ほくろなし', eyeBags:'クマなし', adamsApple:'標準的なのどぼとけ', lipTone:'標準的な血色の唇', browRidge:'彫りは標準的'};

// index.html:5957
export const HIGH_TRAIN = ['しっかり鍛えている（中級）','細マッチョ仕上げ（絞り重視）','機能系（クロスフィット・自重上級）','フィジーク級（大会レベルの絞りと逆三角形）','パワー系（厚み重視の剛力体型）','ボディビル級（過剰な筋肥大）'];
...
// index.html:6704
export const FRIEND_HIER_DELTA = {'上司':[6,15],'先輩':[1,5],'同い年':[0,0],'後輩':[-5,-1]};
...
// index.html:6882
export const IKEMEN_AXIS_LABELS = {faceAsym:'左右差', faceSpacing:'パーツ配置', faceRatio:'目鼻口比率', faceLine:'輪郭', eyebrow:'眉', eyelid:'まぶた', eyeShape:'目の形', eyelash:'まつ毛', nose:'鼻', jawChin:'顎先', jawAngle:'エラ', teethAlign:'歯並び', cheek:'頬', browRidge:'彫り', hairline:'生え際', eyeBags:'クマ', lipTone:'唇の血色'};

// index.html:6916
export const BODYHAIR_KEYS = ['bodyHairOverall','chestHair','abdominalHair','lowerAbdomenHair','armHair','shinHair','thighHair','armpitHair','handFingerHair','footToeHair','backHair'];

// index.html:7660
export const PROMPT_PANES = [['main','pane-main'],['derived','pane-derived'],['outfit','pane-outfit'],['outfitHoliday','pane-outfitHoliday'],['scene','pane-scene'],['friendPair','pane-friendPair'],['group','pane-group']];

// index.html: V3.2.2 smile module data (ported from upstream bc71d5d)
export const SMILE_EYES=['笑うと目が糸のように細くなり三日月形に消える','笑うと目尻が下がって垂れ目になる','笑っても目の形はあまり変わらない（口で笑うタイプ）','笑うと目尻に若い笑い皺が寄る','笑うと片目だけ強く細くなる','笑うと下まぶたが持ち上がる涙袋笑い','笑うと目を見開いて輝かせる','笑うと細まりつつ目に光をたたえる'];
export const SMILE_STYLES=['上の歯をしっかり見せる満面のくしゃ笑い','八重歯がのぞく笑い','口角だけ上げる控えめな笑み','歯を見せない照れ笑い','笑うと鼻に軽くしわが寄る','声が出そうな大口の笑い','口角が左右非対称に上がるニヒルな笑み','はにかんで口元を手で隠しがちな笑い','ふっと息が漏れるような笑い方','にっと横に大きく広がる笑い'];
export const CHEEK_SMILES=['笑うと頬がリンゴのように高く盛り上がる','笑うと頬に縦の笑いジワが入る','笑ってもシャープな頬のまま','笑うと頬とえくぼが連動してへこむ','頬全体が柔らかく持ち上がる'];
export const MOUTH_CORNERS=['地顔でも口角が上がり気味（常に機嫌よく見える）','口角は水平でニュートラル','への字気味（笑うと印象が激変する）','片側だけわずかに上がる'];
