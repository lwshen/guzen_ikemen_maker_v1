...
// index.html:504
export const C_MEASUREMENT_VALUES = [
    '頭を出せずすっぽり',
    '頭を出せるけどすっぽり',
    '頭の先が少し出ている',
    '頭の半分が出ている',
...
// index.html:2642
export const SPORTS = ['野球','サッカー','バスケットボール','バレーボール','ラグビー','柔道','剣道','陸上短距離','陸上長距離','水泳','テニス','卓球','ボクシング','ゴルフ','自転車ロード','体操'];

// index.html:2643
export const SPORT_BODY = {
...
// index.html:2781
export const SPORT_EXP_POOL = ['野球','サッカー','バスケットボール','バレーボール','卓球','テニス','ソフトテニス','バドミントン','陸上（短距離）','陸上（長距離）','水泳','柔道','剣道','空手','相撲','ラグビー','ハンドボール','体操','ボクシング','レスリング','スキー','スケート','自転車競技','ボート','アメリカンフットボール','ダンス','クライミング'];

// index.html:2810
export const SPORT_EXP_WEIGHTS = [['野球',22],['サッカー',17],['バスケットボール',9],['水泳',6.5],['ソフトテニス',3.6],['テニス',3.4],['卓球',4.5],['バドミントン',4],['陸上（短距離）',3],['陸上（長距離）',2.5],['剣道',2],['柔道',1.8],['バレーボール',3],['ラグビー',1.2],['ハンドボール',1],['空手',0.8],['体操',0.8],['ボクシング',0.5],['スキー',0.5],['ダンス',0.5],['アメリカンフットボール',0.4],['自転車競技',0.4],['レスリング',0.3],['スケート',0.3],['ボート',0.3],['クライミング',0.3],['相撲',0.15]];

// index.html:2863
export const SPORT_MUSCLE = {
...
// index.html:3018
export const BODY_ASYMS = [['なし',60],['右肩がごくわずかに下がっている',6],['左肩がごくわずかに下がっている',6],['軽いなで肩',7],['利き腕側の肩がわずかに前に出る',5],['骨盤がごくわずかに傾き、重心が片脚寄り',5],['首がわずかに利き手側へ傾く癖',4]];

// index.html:3019
export const POSTURES = [['自然な立ち姿',52],['背筋の伸びた立ち姿',12],['やや猫背気味',10],['軽く胸を張った立ち姿',8],['リラックスして重心を片脚に預けた立ち方',9],['肩の力が抜けた立ち姿',9]];

// index.html:3020
export const BODY_ASYM_EN = {'右肩がごくわずかに下がっている':'his right shoulder sits a touch lower','左肩がごくわずかに下がっている':'his left shoulder sits a touch lower','軽いなで肩':'gently sloped shoulders','利き腕側の肩がわずかに前に出る':'his dominant-side shoulder rolls slightly forward','骨盤がごくわずかに傾き、重心が片脚寄り':'a barely-tilted pelvis with weight favoring one leg','首がわずかに利き手側へ傾く癖':'a habit of tilting his head slightly toward his dominant side'};

// index.html:3021
export const POSTURE_EN = {'自然な立ち姿':'a natural stance','背筋の伸びた立ち姿':'an upright, straight-backed stance','やや猫背気味':'slightly rounded, hunched posture','軽く胸を張った立ち姿':'a lightly chest-out stance','リラックスして重心を片脚に預けた立ち方':'a relaxed stance with weight on one leg','肩の力が抜けた立ち姿':'a loose-shouldered, easy stance'};

// index.html:3079
export const SPORT_MEM = {
