...
import {
  ...
  function saveCurrent(){ if(!ST.current) return alert(T('saveFirst')); const history=loadHistory(); history.unshift({...ST.current, appVersion:'V3.2.2'}); localStorage.setItem(STORAGE_KEY,JSON.stringify(history.slice(0,50))); renderHistory(); alert(T('saved')); }
