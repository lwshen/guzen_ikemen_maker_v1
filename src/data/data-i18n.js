...
export const slotLabelMap = {
    ...
    skinDetail:{ja:'肌の特徴⑴',en:'Skin Detail 1'}, skinDetail2:{ja:'肌の特徴⑵',en:'Skin Detail 2'},
...
export const uiText = {
    ja:{
      ...
      restoreTitle:'プロンプトから読み込む', restoreCodeBtn:'読み込む', restoreNote:'基準カードの日本語指示文を貼ると、本文から人物設定を読み取って復元します（英語・派生形式は対象外）', restoreNotFound:'プロンプトから人物設定を読み取れませんでした（日本語の基準カード指示文を貼ってください）', restoreFailed:'プロンプトの読み取りに失敗しました', restoreDone:'プロンプトから人物を読み取りました', restorePlaceholder:'基準カードの画像指示文（日本語）を丸ごと貼り付けると人物を読み取ります', favTitle:'お気に入り切替', jsonParseError:'JSONを読み込めませんでした', fullProfTitle:'詳細プロフまとめ（閲覧・転記用）', fullProfNotice:'人物の全設定を読みやすくまとめたテキストです。画像生成用プロンプトではありません。', fullProfPlaceholder:'キャラクターを生成するとここに表示されます', vrefTitle:'動画用参照画像 指示文（基準カードから作成）', videoTitle:'動画プロンプト（SeeDance・日本語／動画差分）', telopTitle:'テロップ提案（後付け編集用）',
    ...
    en:{
      ...
      restoreTitle:'Load from Prompt', restoreCodeBtn:'Load', restoreNote:'Paste the Japanese base-card prompt; the character is parsed from the text itself (English and derived formats are not supported)', restoreNotFound:'Could not parse a character from this text (paste the Japanese base-card prompt)', restoreFailed:'Failed to parse the prompt', restoreDone:'Character parsed from the prompt', restorePlaceholder:'Paste the full Japanese base-card prompt to read the character (Japanese prompts only)', favTitle:'Toggle favorite', jsonParseError:'JSON parse error', fullProfTitle:'Full Profile Summary (view & copy)', fullProfNotice:'A readable text summary of every setting for this character. It is not an image-generation prompt.', fullProfPlaceholder:'Generated characters will appear here', vrefTitle:'Video Reference Still Prompt (from the base card)', videoTitle:'Video Prompt (SeeDance, Japanese / video variation)', telopTitle:'Telop Suggestions (for post editing)',
...
export const valueTranslations = {
    ...
    'やんちゃ系':'Mischievous type','勤務帰り':'After work','勤務中':'On duty','休日':'Day off',
...
Object.assign(uiText.ja.fieldLabels, {
  ...
  initialTraining: '筋トレ習慣', initialFacePresetOut: '顔立ちプリセット出力', initialMjMode: 'Midjourneyモード', manualFacePresetOut: '顔立ちプリセット出力', manualSnapMode: '撮影演出（派生）', manualMjMode: 'Midjourneyモード',
...
Object.assign(uiText.en.fieldLabels, {
  ...
  initialTraining: 'Training Habit', initialFacePresetOut: 'Face-Preset Output', initialMjMode: 'Midjourney Mode', manualFacePresetOut: 'Face-Preset Output', manualSnapMode: 'Photo Style (Derived)', manualMjMode: 'Midjourney Mode',
...
Object.assign(valueTranslations, { '坊主': 'buzz cut' });

Object.assign(valueTranslations, {
  '警察官の勤務制服風（濃紺）': 'police duty uniform style (dark navy)',
  '濃紺の制服シャツ': 'dark navy uniform shirt',
  '迷彩柄の作業服風制服': 'camouflage work-uniform style',
  '医療用スクラブ': 'medical scrubs',
  'スクラブトップス': 'scrub top',
  'スクラブパンツ': 'scrub trousers',
  '白のナースシューズ': 'white nursing shoes',
  '白衣＋スクラブ': 'white coat over scrubs',
  '白のスニーカー': 'white sneakers',
  '白衣スタイル': 'white-coat style',
  '白衣＋シャツ': 'white coat over a shirt',
  'スラックス': 'slacks',
  'ケーシー白衣（医療ユニフォーム）': 'Casey-style medical tunic',
  'ケーシー白衣': 'Casey-style tunic',
  '白の医療用パンツ': 'white medical trousers',
  '介護スタッフのポロシャツユニフォーム': 'care-staff polo uniform',
  'ユニフォームポロシャツ': 'uniform polo shirt',
  '動きやすいチノパン': 'easy-moving chinos',
  'ホテルの制服（ベスト＋ネクタイ）': 'hotel uniform (waistcoat + tie)',
  '白シャツ＋ベスト＋ネクタイ': 'white shirt, waistcoat and tie',
  'シャツ＋カフェエプロン': 'shirt with a cafe apron',
  'シャツ＋ロングエプロン': 'shirt with a long apron',
  '黒パンツ': 'black trousers',
  '黒のプレーントゥ': 'black plain-toe shoes',
  'コンビニの店員ユニフォーム': 'convenience-store staff uniform',
  '店舗ユニフォームシャツ': 'store uniform shirt',
  '黒のスニーカー': 'black sneakers',
  'ベスト＋蝶ネクタイのバーテンダースタイル': 'bartender style with waistcoat and bow tie',
  '白シャツ＋ベスト＋蝶ネクタイ': 'white shirt, waistcoat and bow tie',
  'つなぎの作業服': 'coveralls',
  'つなぎ（上）': 'coveralls (top)',
  'つなぎ（下）': 'coveralls (bottom)',
  '電気工事の作業服': 'electrician work uniform',
  '作業服パンツ': 'work trousers',
  '大工の作業着': 'carpenter work clothes',
  '作業シャツ': 'work shirt',
  'ニッカポッカ風の作業ズボン': 'nikka-pokka style work trousers',
  '足袋風の作業靴': 'tabi-style work shoes',
  '工場の作業服': 'factory work uniform',
  '配送業の制服': 'delivery-service uniform',
  '制服ポロシャツ': 'uniform polo shirt',
  '制服パンツ': 'uniform trousers',
  '作業ズボン': 'work trousers',
  '漁師の作業着（防水前掛け）': "fisherman's work gear (waterproof apron)",
  '作業ジャンパー': 'work jacket',
  '防水パンツ': 'waterproof trousers',
  'ジムスタッフのトレーニングウェア': 'gym-staff training wear',
  'スタッフTシャツ': 'staff T-shirt',
  'トレーニングパンツ': 'training trousers',
  'トレーニングシューズ': 'training shoes',
  'スタッフジャージ上下': 'staff track suit',
  'スタッフジャージ上': 'staff track jacket',
  'スタッフジャージ下': 'staff track pants',
  'ジャージ上下': 'track suit',
  'ジャージ上': 'track jacket',
  'ジャージ下': 'track pants',
  '白のコックコート': 'white chef coat',
  'コックコート': 'chef coat',
  'コックパンツ': 'chef trousers',
  '厨房用シューズ': 'kitchen shoes',
  '白衣＋和帽子の板前スタイル': 'itamae style: white tunic and Japanese cap',
  '白の調理パンツ': 'white kitchen trousers',
  '厨房用サンダルではなく作業靴': 'work shoes rather than kitchen sandals',
  '作務衣風の調理着＋タオル鉢巻': 'samue-style kitchen wear with a towel headband',
  '作務衣風パンツ': 'samue-style trousers',
  '厨房用の作業靴': 'kitchen work shoes',
  '作務衣パンツ': 'samue trousers',
  '雪駄ではなく作業用の履物': 'work footwear rather than setta',
  '国鉄の駅員制服風': 'JNR station-staff uniform style',
  '制服スラックス': 'uniform slacks',
  'チームのトレーニングウェア（実在チームのロゴなし）': 'team training wear (no real team logos)',
  'トレーニングトップ': 'training top',
  'スポーツシューズ': 'sports shoes',
  'ライフガードの監視ユニフォーム（赤×黄）': 'lifeguard watch uniform (red and yellow)',
  'GUARDと書かれた赤のタンクトップ（実在団体ロゴなし）': 'red tank top reading GUARD (no real organisation logos)',
  '赤のサーフパンツ': 'red board shorts',
  'ビーチサンダルまたは素足＋ホイッスルを首から下げる': 'flip-flops or bare feet, whistle around the neck',
  'プール監視員のスタッフウェア': 'pool-monitor staff wear',
  'スタッフTシャツ（STAFF表記・実在ロゴなし）': 'staff T-shirt marked STAFF (no real logos)',
  'スイムハーフパンツ': 'swim shorts',
  'プールサンダル＋ホイッスル': 'pool sandals and a whistle',
  '警備会社の制服風（グレー系）': 'security-company uniform style (grays)',
  'グレーの制服シャツ＋肩章': 'gray uniform shirt with epaulettes',
  '黒の革靴＋白手袋を携行': 'black leather shoes, white gloves carried',
  '鉄道乗務員の制服風（濃紺）': 'train-crew uniform style (dark navy)',
  '濃紺の制服上衣＋ネクタイ': 'dark navy uniform jacket and tie',
  'エアラインパイロットの制服風': 'airline pilot uniform style',
  '白の制服シャツ＋黒ネクタイ＋袖に金線の入った濃紺ジャケット（実在会社ロゴなし）': 'white uniform shirt, black tie and a dark navy jacket with gold sleeve stripes (no real airline logos)',
  '白衣＋スクラブの医師スタイル': 'doctor style: white coat over scrubs',
  '白のスニーカー・聴診器を首に掛ける': 'white sneakers, stethoscope around the neck',
  '歯科用スクラブスタイル': 'dental scrub style',
  '半袖スクラブトップス': 'short-sleeve scrub top',
  '白のクリニックシューズ': 'white clinic shoes',
  'タクシー乗務員の制服風': 'taxi-driver uniform style',
  '白の制服シャツ＋ネクタイ': 'white uniform shirt and tie',
  '黒の制服スラックス': 'black uniform slacks',
  '黒の革靴＋白手袋': 'black leather shoes and white gloves',
  'バス乗務員の制服風': 'bus-driver uniform style',
  '水色の制服シャツ': 'light-blue uniform shirt',
  '配達員の制服風（実在事業者ロゴなし）': 'courier uniform style (no real carrier logos)',
  '配達用ポロシャツ': 'delivery polo shirt',
  '配達用パンツ': 'delivery trousers',
  '引越し会社のスタッフウェア': 'moving-company staff wear',
  'スタッフポロシャツ（実在会社ロゴなし）': 'staff polo shirt (no real company logos)',
  '動きやすい作業パンツ': 'easy-moving work trousers',
  '滑りにくいスニーカー＋腰にタオル': 'non-slip sneakers with a towel at the waist',
  'スーパーの店員ユニフォーム＋エプロン': 'supermarket staff uniform with apron',
  '店舗ポロシャツ＋エプロン': 'store polo shirt with apron',
  '量販店の店員ユニフォーム': 'big-box store staff uniform',
  '店舗カラーのユニフォームシャツ（実在店ロゴなし）': 'uniform shirt in store colors (no real store logos)',
  '白のコックコート＋ソムリエエプロン': 'white chef coat with a sommelier apron',
  '黒のソムリエエプロン＋コックパンツ': 'black sommelier apron with chef trousers',
  '理容師のバーバースタイル': 'barber style',
  '黒のバーバーエプロン＋白シャツ': 'black barber apron over a white shirt',
  '教習所指導員の制服風': 'driving-instructor uniform style',
  '水色の制服シャツ＋ネクタイ': 'light-blue uniform shirt and tie',
  'グレーの制服スラックス': 'gray uniform slacks',
  '銭湯スタッフの作務衣スタイル': 'bathhouse staff samue style',
  '作務衣風の上衣（店名ロゴなし）': 'samue-style top (no shop logos)',
  '司書のエプロンスタイル': 'librarian apron style',
  'シャツ＋無地エプロン': 'shirt with a plain apron',
  '歩きやすい革靴': 'comfortable walking leather shoes',
  '小学校の先生スタイル（ジャージ＋ポロシャツ）': 'elementary-teacher style (track wear and polo)',
  'ポロシャツ＋ジャージ上着': 'polo shirt with a track jacket',
  '上履き用の白スニーカー': 'white indoor sneakers',
  '中学校の先生スタイル（シャツ＋ジャージ）': 'junior-high teacher style (shirt and track wear)',
  'ワイシャツ（腕まくり）': 'dress shirt with sleeves rolled up',
  'ジャージパンツまたはスラックス': 'track pants or slacks',
  'しまむら': 'Shimamura',
  '仕立て': 'tailored',
  '足袋': 'tabi socks',
});
...
Object.assign(valueTranslations, {
  '幼稚園': 'kindergarten', '小学校': 'elementary school', '中学校': 'junior high',
  '高校': 'high school', '大学': 'university', '社会人': 'adult leagues',
});

// V3.9.6 port: new outfit styles / colors / brands / brow grooming / fashion-sense values
Object.assign(valueTranslations, {
  'アメカジ': 'American casual',
  'オールブラック・ミニマル': 'all-black minimal',
  'オフィスカジュアル': 'office casual',
  'お兄系': 'onii-kei (flashy-mature style)',
  'きれいめストリート': 'clean-cut street style',
  'きれいめ私服出勤': 'smart-casual commute wear',
  'ゴープコア': 'gorpcore',
  'サーフ系': 'surf style',
  'シティボーイ': 'city-boy style',
  'ジャケパン': 'blazer and slacks',
  'セットアップカジュアル': 'casual matching set-up',
  'テックウェア': 'techwear',
  'ノームコア': 'normcore',
  'ビジネスカジュアル': 'business casual',
  'ブリティッシュトラッド': 'British trad',
  'フレンチカジュアル': 'French casual',
  'ワークウェアスタイル': 'workwear style',
  'ワークマン系機能カジュアル': 'Workman-style functional casual',
  'ワンマイルウェア': 'one-mile wear',
  '白シャツ×黒パン': 'white shirt and black pants',
  '和カジュアル': 'Japanese-style casual',
  '渋谷系': 'Shibuya-kei style',
  '裏原系': 'Ura-Harajuku style',
  'オレンジの救助服（レスキュー隊風）': 'orange rescue uniform (rescue-squad style)',
  '夏の車夫スタイル（半袖法被・脚絆）': 'summer rickshaw-puller outfit (short-sleeve happi coat, leg wraps)',
  '夏制服（水色シャツ×濃紺スラックス・帯革と肩章）': 'summer uniform (light-blue shirt, dark navy slacks, duty belt and epaulettes)',
  '観光人力車の車夫装束（法被・股引・地下足袋）': 'tourist-rickshaw puller outfit (happi coat, momohiki trousers, jika-tabi boots)',
  '屋号入りの法被': 'happi coat with the shop crest',
  '黒の股引': 'black momohiki trousers',
  '紺の地下足袋': 'navy jika-tabi boots',
  '人力車の車夫': 'rickshaw puller',
  '当番表': 'duty roster',
  'スニーカーソックス': 'sneaker socks',
  'リブソックス': 'ribbed socks',
  'ワンポイント白': 'white with a one-point accent',
  '厚手のパイルソックス': 'thick terry socks',
  'ワークマン': 'Workman',
  'クラークス': 'Clarks',
  '（指定なし）': '(unspecified)',
  'オリーブ': 'olive',
  ...
  'ベージュ': 'beige',
  '赤の差し色': 'a red accent',
  '白の厚底ダッド系': 'chunky white dad-style sneakers',
  '自然なまま': 'left natural',
  '整えた形': 'neatly shaped',
  'きっちりライン取り': 'sharply lined',
  '剃り込み跡あり': 'with shaved-in lines',
  '眉間は近め': 'close-set brows',
  '標準的な眉間': 'average brow spacing',
  '眉間は離れ気味': 'wide-set brows',
  'アイロンと毛玉取りが習慣': 'ironing and de-pilling are part of his routine',
  'サイズ違いで2枚買う慎重派': 'the cautious type who buys two sizes of the same item',
  'ジム服がそのまま私服化している': 'his gym clothes have become his everyday wear',
  'スーツ以外の服をほぼ持っていない': 'owns almost nothing but suits',
  'セール品しか買わない主義': 'only ever buys things on sale',
  'ハイブランド1点主義（あとは無難）': 'one high-brand piece, everything else safe',
  'フリマアプリで売る前提で買う': 'buys with flea-market-app resale in mind',
  'ワークマンで全部済むと気づいてしまった': 'realized Workman covers everything he needs',
  '靴だけは絶対に妥協しない': 'never compromises on shoes',
  '黒しか着ない': 'wears nothing but black',
  '試着室のカーテンを開けるのが苦手（通販派）': 'hates opening the fitting-room curtain (mail-order type)',
  '推しと同じ服を探して買う': 'hunts down the same clothes his fave wears',
  '体型が変わって服が合わない（買い替えは渋る）': 'his body changed and clothes no longer fit (reluctant to rebuy)',
  '憧れの先輩の着こなしを丸ごと真似ている': "copies an admired senior's whole style",
  '彼女に選んでもらうのが毎回楽しみ': 'looks forward to having his girlfriend pick his clothes',
  '流行は先取りしないと気が済まない': 'not satisfied unless he is ahead of the trend',
  '15秒（2.0）': '15s (2.0)',
  '30秒（2.5）': '30s (2.5)',
});
